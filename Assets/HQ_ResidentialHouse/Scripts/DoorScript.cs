...
public class DoorScript : MonoBehaviourPun {
	...
	public string openingText = "[BUTTON]을 누르면 문이 열립니다";
	public string closingText = "[BUTTON]을 누르면 문이 닫힙니다";
	...
	public class DoorTexts
	{
		...
		string openingText = "[BUTTON]을 누르면 문이 열립니다";
		string closingText = "[BUTTON]을 누르면 문이 닫힙니다";
